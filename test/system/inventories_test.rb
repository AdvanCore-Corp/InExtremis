...
class InventoriesTest < ApplicationSystemTestCase
  ...
  test "should create inventory" do
    ...
    fill_in "Cost", with: @inventory.cost
    fill_in "Date purchase", with: @inventory.date_purchase
    fill_in "Muscle group", with: @inventory.muscle_group
    fill_in "Type inventory", with: @inventory.type_inventory_id
    fill_in "Type machine", with: @inventory.type_machine
